...
<div class="relative select-none" id="single-wrapper">
    <div class="w-full">
        ...
        <div>
            ...
            <?php } else { ?>
                <div class="swiper mySwiper--tabs bg-yellow-500 py-4">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <button type="button"
                                class="inline-block p-4 text-white hover:bg-black/40 transition-colors uppercase tracking-wider"
                                id="presentacion-tab-mobile"
                                data-tabs-target="#presentacion"
                                role="tab"
                                aria-controls="presentacion"
                                aria-selected="true">
                        ...
                        <div class="swiper-slide">
                            <a href="/contacto-inversiones-inmobiliarias"
                                class="inline-block p-4 text-white hover:bg-black/40 transition-colors uppercase tracking-wider whitespace-nowrap"
                                target="_blank">
                                Hablar con asesor
                            </a>
                        </div>
                    ...
                    <div class="w-full py-20 bg-white">
                        <div class="container mx-auto py-10">
                            <div class="max-w-7xl mx-auto">
                                <h1 class="font-bold text-center underline uppercase tracking-widest text-4xl md:text-5xl text-blue-500 leading-tight"><?php the_field('proyecto-copy'); ?></h1>
