...
<!-- Tipos -->
    ...
    <div>
        <h3 class="text-center display-5">Tipos</h3>
        <div class="grilla-2 <?php if(wp_is_Mobile()) echo 'gap-2 text-center';else echo 'gap-4'?>">
            <?php while (have_rows('proyecto-tipos')) : the_row(); ?>
                <div class="flex-center flex-column border py-5">
                    <h4 class="lh-1"><?php the_sub_field('titulo-tipo'); ?></h4>
                    <img class="imagen-tipo" src="<?php the_sub_field('imagen-tipo'); ?>">
                    <?php if (get_sub_field('area-tipo')) : ?>
                        <svg class="my-2" width="20" height="20" viewBox="0 0 400 400" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <h5 class="fw-normal <?php if(wp_is_Mobile()) echo 'small';?>"> <span class="fw-bold pe-1">Área:</span><span> <?php the_sub_field('area-tipo'); ?> m²</span></h5>
                    <?php endif; ?>
                    <?php if (get_sub_field('precio-tipo')) : ?>
                        <h5 class="precio-tipo">$
                            <?php
